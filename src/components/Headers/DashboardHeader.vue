    ...
    <a-layout-header>
      <a-row type="flex">
        ...
        <a-col :md="6" :span="24">
          ...
          <a-breadcrumb>
            <a-breadcrumb-item>
              <router-link to="/"> 页面</router-link>
            </a-breadcrumb-item>
            <a-breadcrumb-item v-if="this.$route.name==='Dashboard'">打印机</a-breadcrumb-item>
            <a-breadcrumb-item v-if="this.$route.name==='Tables'">数据表</a-breadcrumb-item>
            <a-breadcrumb-item v-if="this.$route.name==='Billing'">其他</a-breadcrumb-item>
          </a-breadcrumb>
          <!-- / Header Breadcrumbs -->

          <!-- Header Page Title -->
          <div class="ant-page-header-heading">
            <span class="ant-page-header-heading-title" v-if="this.$route.name==='Dashboard'">打印机</span>
            <span class="ant-page-header-heading-title" v-if="this.$route.name==='Tables'">数据表</span>
            <span class="ant-page-header-heading-title" v-if="this.$route.name==='Billing'">其他</span>
          </div>
          <!-- / Header Page Title -->
        ...
        <a-col :md="18" :span="24" class="header-control">
          ...
          <a-dropdown :getPopupContainer="() => wrapper" :trigger="['click']"
            ...
            <a-list slot="overlay" :data-source="notificationsData" class="header-notifications-list"
              ...
              <a-list-item slot="renderItem" slot-scope="item">
                <a-list-item-meta>
                  ...
                  <a-avatar v-else
                            slot="avatar"
                            shape="square" v-html="item.svg"/>
                </a-list-item-meta>
              </a-list-item>
            </a-list>
          </a-dropdown>
          <a-button ref="secondarySidebarTriggerBtn" type="link" @click="$emit('toggleSettingsDrawer', true)">
            <svg fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
              <path clip-rule="evenodd"
          ...
          <a-button class="sidebar-toggler" type="link"
          ...
          <router-link class="btn-sign-in" to="/sign-in/0" @click="e => e.preventDefault()">
            <svg fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
              <path clip-rule="evenodd"
          ...
          <!-- Header Search Input -->
          <!--          <a-input-search :class="searchLoading ? 'loading' : ''" :loading='searchLoading' class="header-search"-->
          <!--                          placeholder="Type here…" @search="onSearch">-->
          <!--            <svg slot="prefix" fill="none" height="16" viewBox="0 0 20 20" width="16"-->
