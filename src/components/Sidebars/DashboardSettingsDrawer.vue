<template>
  ...
  >
    ...
    <a-button class="btn-close" type="link" @click="$emit('toggleSettingsDrawer', false)">
      <svg height="9" viewBox="0 0 9 9" width="9" xmlns="http://www.w3.org/2000/svg">
        <g id="close" transform="translate(0.75 0.75)">
          <path id="Path" d="M7.5,0,0,7.5" fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                stroke-miterlimit="10" stroke-width="1.5"/>
          <path id="Path-2" d="M0,0,7.5,7.5" data-name="Path" fill="none" stroke="#000" stroke-linecap="round"
    ...
    <div class="drawer-content">
      ...
      <div class="sidebar-color">
        <h6>Sidebar Color</h6>
        <a-radio-group v-model="sidebarColorModel" defaultValue="primary"
                       @change="$emit('updateSidebarColor', $event.target.value)">
          <a-radio-button class="bg-primary" value="primary"></a-radio-button>
          <a-radio-button class="bg-secondary" value="secondary"></a-radio-button>
          <a-radio-button class="bg-success" value="success"></a-radio-button>
          <a-radio-button class="bg-danger" value="danger"></a-radio-button>
          <a-radio-button class="bg-warning" value="warning"></a-radio-button>
          <a-radio-button class="bg-dark" value="black"></a-radio-button>
        </a-radio-group>
      </div>
      <div class="sidenav-type">
        <h6>Sidenav Type</h6>
        <p>Choose between 2 different sidenav types.</p>
        <a-radio-group v-model="sidebarThemeModel" button-style="solid"
                       defaultValue="primary" @change="$emit('updateSidebarTheme', $event.target.value)">
      ...
      <div class="navbar-fixed">
        <h6>Navbar Fixed</h6>
        <a-switch v-model="navbarFixedModel" default-checked @change="$emit('toggleNavbarPosition', navbarFixedModel)"/>
      </div>
      <!--			<div class="download">-->
