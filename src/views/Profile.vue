...
<template>
  <div>
    ...
    <!-- User Profile Card -->
    <a-card :bodyStyle="{padding: 0,}" :bordered="false" class="card-profile-head">
      <template #title>
        <a-row align="middle" type="flex">
          <a-col :md="12" :span="24" class="col-info">
    ...
    <a-row :gutter="24" type="flex">
      ...
      <a-col :md="8" :span="24" class="mb-24">
    ...
    <!-- Projects Card -->
    <a-card :bodyStyle="{paddingTop: '14px'}" :bordered="false" class="header-solid h-full mb-24">
      <template #title>
      ...
      <a-row :gutter="[24,24]" align="stretch" type="flex">
        ...
        <!-- Project Column -->
        <a-col v-for="(project, index) in projects" :key="index" :md="12" :span="24" :xl="6">
          <CardProject
              :id="project.id"
